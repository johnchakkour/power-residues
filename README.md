...
For which primes $q=ef+1$ is $2$ an $e$-th power residue mod $q$? The classical 
...
The cyclotomic extension $\mathbb{Q}(\zeta_q)/\mathbb{Q}$ has Galois group 
$(\mathbb{Z}/q\mathbb{Z})^\times$, which has a unique subgroup $C_0$ of 
index $e$ and order $f$. To $C_0$ and its cosets $C_1,\dots,C_{e-1}$ we
